...
const moduleWindow = document.querySelector(".module-agree");
const overlay = document.querySelector(".overlay");
const moduleBtnDa = document.querySelector(".module-button-one");
const moduleBtnNu = document.querySelector(".module-button-two");
...
const AddRow = (row = {}) => {
  ...
  list1.push({
    ...
    datanasterii:
      row.datanasterii || document.getElementById("datepicker").value,
    autovehicul:
      row.autovehicul || document.getElementById("autovehicul").value,
...
clearBtn.addEventListener("click", () => {
  ...
  moduleBtnDa.addEventListener("click", () => {
    localStorage.clear();
    window.location.reload();
  });

  moduleBtnNu.addEventListener("click", () => {
